...
// Reliable static images for the bottom grid
const COURSE_RESEARCH_IMGS = [
  "https://images.unsplash.com/photo-1517336714731-489689fd1ca4?auto=format&fit=crop&w=400&q=80", // Piano/Music
  "https://images.unsplash.com/photo-1544396821-4dd40b938ad3?auto=format&fit=crop&w=400&q=80", // Child singing
  "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&w=400&q=80", // Kids learning
  "https://images.unsplash.com/photo-1524178232363-1fb2b075b955?auto=format&fit=crop&w=400&q=80"  // Classroom
];
...
const Home: React.FC<HomeProps> = ({ onEnterResearch, onEnterCourse, initialActiveItem }) => {
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-center justify-between">
             ...
             <div className="flex flex-col gap-3">
                <button className="bg-[#EAB308] hover:bg-[#CA8A04] text-white px-8 py-2 rounded-md text-sm font-bold shadow-sm transition-all">
                   创建教研活动
                </button>
